...
{
	//echo $code_disc_id[$special_code];
	//echo "<br>";
	//echo $disc_id_amt[$code_disc_id[$special_code]];
	//echo "<br>";
	...
	?>
	<!-- Array ( [description] => $50 discount off the retail price [name] => Special Email Offer [applyDiscountToCommission] => 1 [productId] => 5 )  -->
