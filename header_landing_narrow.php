...
<link rel="pingback" href="http://www.builtlean.com/xmlrpc.php" />
	<?php wp_head(); 
		...
		include("infapi.php");
		if(isset($_REQUEST['orderId']) && isset($_REQUEST['contactId']) && ($alias == 'thank-you-purchase')) {
	?>
...
<?php } ?>
	...
	<div>
<img src="http://www.builtlean.com/wp-content/themes/builtlean/images/logo_landingpage.jpg" width="192" height="26" alt="BuiltLean.com"/></div> 
    </div>
	</div>
<div class="wrap_alt">
