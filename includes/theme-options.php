...
$admincpMainTabs = array('general','layout');
...
$options = array (
	...
	array( "name" => "nav-general",
		...
		/*	array( "name" => "Theme Stylesheet",
				   ...
				   "type" => "select",
				   "std" => "default.css",
				   "options" => array("default.css", "green.css", "red.css", "brown.css", "black.css", "pink.css"),
...
*/
		  ...
		  /*array( "name" => "Custom CSS",
			...
			array( "name" => "Select Featured Category",
				   "id" => $shortname."_featured_cat_articles",
				   "type" => "select",
					"options" => $cats_names,
				   "std" => "",
				   "desc" => "Select a category for featured articles",),			   
	...
	array( "name" => "nav-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => "Homepage Layout",
				   ...
				   "type" => "select",
				   "std" => "Sidebar | Content",
				   "options" => array("Sidebar | Content", "Content | Sidebar"),
				   "desc" => "desc.",),	 

			array( "name" => "Content Layout",
				   "id" => $shortname."_content_layout",
				   "type" => "select",
				   "std" => "Layout #1",
				   "options" => array("Layout #1", "Layout #2", "Layout #3"),
				   "desc" => "desc.",),	   
			
			array( "name" => "Number of featured posts to show (Layout #1)",
				   "id" => $shortname."_featured_post_num",
				   "type" => "text",
				   "std" => "1",
				   "desc" => "desc",),

			array( "name" => "Input comma-separated tags for the featured posts (Layout #1)",
				   "id" => $shortname."_featured_post_tags",
				   "type" => "text",
				   "std" => "featured, breaking",
				   "desc" => "desc",),

			array( "name" => "Display a Retweet button after posts",
                   "id" => $shortname."_retweet_button_enable",
                   "type" => "checkbox",
                   "std" => "false",
                   "desc" => "desc. "),				   					   			   
		...
		array( "name" => "layout-2",
			...
			array( "name" => "Show related articles & ad(300x250) box on posts",
                   "id" => $shortname."_show_related_ad_box",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "desc. "),                   
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "nav-advertisements",
		...
		array( "name" => "advertisements-1",
			...
			array( "name" => "Enable home content ad (468x60)",
				   "id" => $shortname."_home_content_ad_enable",
				   	"type" => "checkbox",
				   "std" => "on",
				   "desc" => "desc.",),
			...
			array( "name" => "Enable entry bottom ad (300x250)",
				   "id" => $shortname."_entry_bottom_ad_enable",
				   	"type" => "checkbox",
				   "std" => "on",
				   "desc" => "Ad space that under single post, next to Related Posts.",),   				   

			array( "type" => "clearfix",),
				   
			array( "name" => "Input home content ad code",
				   "id" => $shortname."_home_content_ad_code",
				   "type" => "textarea",
				   "std" => "Go to Smartblog Theme Options -> Ad Management to enter your ad code (468x60)",
				   "desc" => "desc",),

			array( "name" => "Input entry bottom ad code",
				   "id" => $shortname."_entry_bottom_ad_code",
				   "type" => "textarea",
				   "std" => "Go to Smartblog Theme Options -> Ad Management to enter your ad code (300x250)",
				   "desc" => "desc",),		   				   
